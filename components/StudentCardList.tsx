  ...
  return (
    ...
    <div className="overflow-hidden">
      <div className="min-w-screen  flex items-center justify-center overflow-hidden">
        ...
        <div className="students w-full ml-50 mr-5 shadow-md mb-5 py-3 mt-8">

        <div className="ml-60 shadow-md mb-5 py-3 mt-8">
