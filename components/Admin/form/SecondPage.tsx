            ...
            <div className="relative  py-8 bg-white   mx-8 md:mx-0  rounded-md sm:p-10">
              <div className="max-w-md mx-auto">
                <div className="  flex  flex-col items-center justify-center gap-4 text-sm ">
                  ...
                  <h2 className="uppercase">Step 2</h2>
                </div>
                  ...
                  <div
                    ...
                    <div className="flex items-center space-x-16 text-sm ">
                      ...
                      <div className="flex flex-col items-end mt-4 ">
                        <button
                          className="px-4 py-2 flex justify-center items-center w-24 border bg-primary rounded text-white focus:outline-none" onClick={() => moveBack()}>Previous</button>
                      </div>
                      <div className="flex flex-col items-end mt-4 ">
                        <button
                          className="px-4 py-2 flex justify-center items-center w-24 border bg-primary rounded text-white focus:outline-none">Finish</button>
                      </div>
                    </div>
