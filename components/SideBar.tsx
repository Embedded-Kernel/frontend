...
const SideBar = () => {
    return (
        <div className="relative w-full min-h-screen md:flex">
            <div
                className="sidebar text-blue-100 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
                ...
                <nav>
                    ...
                    <Link href="/logout">
                        <a className="block mt-60 group flex items-center py-2.5 px-7  transition duration-200">
                            <RiArrowLeftRightFill/><span>Log out</span>
                        </a>
                    </Link>
                </nav>
            </div>
