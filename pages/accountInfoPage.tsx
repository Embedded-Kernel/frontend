            ...
            <div className="col-span-10">
                ...
                <div className="p-12">
                    ...
                    <div className="h-20 flex w-full">
                        ...
                        <div className="flex-col w-2/4">
                            <button
                                className="border-2 border-red-200 p-1 w-32 shadow-md float-right hover:bg-red-500 hover:border-0 hover:text-white focus:outline-none hover:outline-none">Delete
                                account
                            </button>
                        </div>
                    </div>
