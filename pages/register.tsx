        ...
        <div className="container grid grid-cols-12">
            ...
            <div className="col-span-8">
                ...
                <div className="ml-10 mt-10 flex flex-col">
                    <p className="font-sans text-4xl mb-3">Create an account in Smart SC</p>
                    ...
                    <div className="flex gap-x-20 flex-row mt-7 w-full flex-start pr-6">
                        <div className="flex flex-col gap-y-7 w-2/4">
                            ...
                            <button className="bg-sideBarColor shadow-lg text-white font-[semi-bold] py-2 w-32">Sign Up</button>
                        </div>
